...
<nav class="navbar">
    ...
    <div class="container" id="main-tabs">
        <div class="fable">
            <img src="img/kancildanbuaya.jpg">
            <h2>Kancil Cerdik dan Buaya</h2>
            <p>
                ...
                Kancil lalu meminta buaya-buaya di sungai berkumpul. Ia mulai menghitung buaya di sungai lalu kabur. 
                Berkat kecerdikannya, dia berhasil lolos dari buaya-buaya yang lapar.
            ...
            <p>
                <strong>Nilai Moral:</strong> Cerita ini mengajarkan kita tentang kecerdikan yang disalahgunakan.
            </p>
        </div>

        <div class="fable">
            <img src="img/tikusdansinga.jpg">
            <h2>Persahabatan Singa dan Tikus</h2>
            <p>
            ...
            <p>
                <strong>Nilai Moral:</strong> Menolong teman yang kesusahan adalah perbuatan baik dan akan mendapatkan balasan suatu hari nanti.
            </p>
        </div>

        <div class="fable">
            <img src="img/kurakuradanbebek.jpg">
            <h2>Kura-Kura dan Sepasang Itik</h2>
            <p>
                Dikisahkan ada seekor kura-kura yang telah dihukum oleh dewa Jupiter. Kura-kura tersebut dihukum karena malas, sehingga lebih senang di rumah dan tidak menghadiri pesta pernikahan dewa Jupiter. 
                Padahal, kura-kurang telah diundang secara khusus oleh dewa Jupiter.
                ...
                Hingga suatu ketika, kura-kura bertemu dengan sepasang itik dan menceritakan keluh kesahnya. Kemudian itik tersebut berkata, "Kami dapat menolongmu untuk melihat dunia.
                Berpeganglah pada kayu ini dengan gigimu dan kami akan membawamu jauh ke atas langit di mana kamu bisa melihat seluruh daratan di bawahmu. Tetapi kamu harus diam dan tidak berbicara atau kamu akan sangat menyesal."
                Tanpa berpikir panjang, kura-kura pun langsung mengiyakan hal tersebut. Dengan cepat ia memegang kayu tersebut erat-erat dengan giginya. 
            ...
            <p>
                <strong>Nilai Moral:</strong> Dari cerita ini kita diajarkan untuk tidak bermalas-malasan dan tidak boleh sombong.
            </p>
        </div>
    </div>
