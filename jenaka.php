...
<nav class="navbar">
    ...
    <div class="container" id="main-tabs">
        <div class="Jenaka">
            <h2>Lalat yang lupa namanya sendiri</h2>
            <p>
        ...
        <div class="Jenaka">
            <h2>Pertandingan bintang besar dan bintang kecil</h2>
            <p>
                ...
                Pada babak pertama, pertandingan dimenangkan oleh kelompok binatang yang berukuran besar. Tentu saja hal ini membuat para binatang berukuran besar merasa senang. 
                Tapi pada babak kedua, permainan dimenangkan oleh kelompok binatang berukuran kecil. Kali ini yang berhasil mencetak gol adalah, kaki seribu. Hingga akhirnya di babak terakhir, kelompok binatang berukuran kecil yang memenangkan pertandingan.            
