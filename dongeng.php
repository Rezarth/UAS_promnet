...
<head>
    ...
    <title>Dongeng Stories</title>
</head>
<body>
    <nav class="navbar">
        <div class="logo_mobile">
                <a href="index.php">
                    <img class="picture" src="img/logo7.png">
                    <button class="btn btn-primary" href="index.php">Home</button>
                </a>
        </div>
    </nav>
    <div class="container" id="main-tabs">
        <div class="cerita">
            ...
            <p>
                ...
                Suatu hari ketika sedang mencuci, baju ibu tiri Bawang Putih hanyut. Bawang Putih pun bingung sampai akhirnya bertemu dengan seorang nenek yang mengatakan kalau ia menyimpan baju yang hanyut itu dan akan
                mengembalikannya dengan satu syarat. Bawang Putih harus membantu mengerjakan pekerjaan rumah. Bawang Putih pun menuruti.
            ...
            <p>
                <strong>Nilai Moral:</strong> Tidak boleh berperilaku buruk terhadap orang lain dan memiliki sifat serakah.
            </p>
        </div>

        <div class="Dongeng">
            <h2>petani serakah</h2>
            <p>
            ...
            <p>
                <strong>Nilai Moral:</strong> Bersyukurlah atas apa yang sudah dimiliki dan hindari keserakahan yang berlebihan.
            </p>
        </div>
        ...
        <div class="Dongeng">
            ...
            <p>
                ...
                Tanpa pikir panjang, Mbok Sirni pun menyetujuinya. Buto Ijo memberikan bibit timun untuk ditanam. 
                Katanya salah satu dari timun itu nanti ada timun paling besar berwarna emas. Timun itulah yang berisi bayi.
                Benar saja, dua minggu setelah bibit timun ditanam, Mbok Sirni menemukan timun yang paling besar diantara timun lainnya dan berwarna emas. 
                Ketika dibelah, berisi bayi perempuan yang kemudian diberi nama Timun Emas oleh Mbok Sirni.
                Beberapa tahun berlalu, Timun Emas dan Mbok Sirni selalu bersama sampai tiba saatnya Buto Ijo datang untuk mengambil Timun Emas. 
                Mbok Sirni sangat menyayangi Timun Emas lalu ia berdo'a agar selalu bersama. Kemudian datanglah seorang petapa yang memberinya bungkusan kecil berisi biji mentimun, jarum, garam, dan terasi.
            ...
            <p>
                <strong>Nilai Moral:</strong> Dari cerita ini kita diajarkan untuk tidak bermalas-malasan dan tidak boleh sombong.Kesetiaan, keberanian, dan doa tulus dapat mengatasi berbagai tantangan dalam hidup.
            </p>
        </div>
    </div>
    ...
    <div class="copyright_section">
        <div class="container">
            <p1 class="copyright_text">2023 All Rights Reserved. Design by <a href="https://7KIDS">7KIDS STORY</a></p1>
        </div>
    </div>
